        ...
        return new Promise((resolve, reject) => {
            try {
                ...
                if (fs.existsSync(savePath)) {
                    ...
                    this.sendToRenderer('model-download-complete', { path: savePath });
                    resolve(savePath);
                    return;
                }
                ...
                this.sendToRenderer('model-download-status', { message: 'Starting download...' });
                    ...
                    if (response.statusCode === 302 || response.statusCode === 301) {
                        ...
                        https.get(redirectUrl, (redirectResponse) => {
                            ...
                            redirectResponse.on('data', (chunk) => {
                                ...
                                this.sendToRenderer('model-download-progress', {
                ...
                request.on('error', (err) => {
                    ...
                    this.sendToRenderer('model-download-error', { error: err.message });
                    reject(err);
                });
                ...
                this.sendToRenderer('model-download-error', { error: String(error) });
                reject(error);
            }
        });
    }
